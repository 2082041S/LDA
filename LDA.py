...
def generate_gamma_and_phi_for_each_document():
...
def print_evaluation_criteria():
    ...
    for i in range(number_of_topics):
        ...
        print beta[i]
    end_LDA = time.time()
    print "Running the algorithm ", iterations, " times takes ", end_LDA - end_preprocess, " seconds"
...
generate_gamma_and_phi_for_each_document()
