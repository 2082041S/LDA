...
class VariationalLDA(object):
    ...
    def run_vb(self, n_its=1, verbose=True, initialise=True):
        ...
        for it in range(n_its):
            ...
            if verbose:
                print "Iteration {} (change = {}) ({} seconds, I think I'll finish in {} minutes)".format(it, diff,
                                                                                                          end_time - start_time,
                                                                                                          estimated_finish)
    ...
    def run_vb(self, n_its=10, initialise=True, parallel=False):
        ...
        for it in range(n_its):
            ...
            if parallel:
                ...
                for l in ldas:
                    param_set = (
                    l.corpus, l.K, l.n_words, l.doc_index, l.alpha, l.word_index, l.phi_matrix, l.beta_matrix,
                    l.gamma_matrix)
