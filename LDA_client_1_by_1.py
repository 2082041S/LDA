...
def update_beta_and_send_it_to_master(result_q, job, corpus):
        ...
        if process_current_iteration <= server_iteration_q.qsize() or client_crashed:
            ...
            try:
                ...
                # before computing new_betas
                    ...
                    corpus = corpus_list[corpus_index]
                    # get_beta_for_each_extra_corpus(job_q, corpus_list)
                    corpus = update_beta_and_send_it_to_master(result_q, job, corpus)
                    corpus_index = corpus_index + 1
                    if corpus_index == len(corpus_list):
                        corpus_index = 0
